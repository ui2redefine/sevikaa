...
export default function Footer() {
  ...
  return (
    <footer className="footerRoot bg-[var(--brand-900)] text-gray-300 pt-14 pb-6" role="contentinfo">
      <div className="footerInner max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="footerContactInfo">
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li>
              <a href={`mailto:${email}`} className="flex items-start gap-2 hover:text-white transition-colors" aria-label={`Email us at ${email}`}>
      ...
      <div className="footerBottom max-w-6xl mx-auto px-4 sm:px-6 mt-10 pt-6 border-t border-white/15 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/70">
