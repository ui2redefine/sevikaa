...
export default function WhatsAppFAB() {
  ...
  return (
    ...
    >
      {/* WhatsApp SVG icon */}
      <span className="flex items-center justify-center w-14 h-14" aria-hidden="true">
      ...
      <span className="hidden group-hover:inline-block pr-4 text-sm font-semibold whitespace-nowrap">
        Chat with us
      </span>
    </a>
  );
